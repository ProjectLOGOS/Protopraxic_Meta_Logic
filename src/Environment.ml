...
module Retroknowledge =
 struct
  type t = { retro_int63 : kername option; retro_float64 : kername option;
             retro_string : kername option; retro_array : kername option }
  ...
  (** val retro_string : t -> kername option **)
  ...
  let empty =
    { retro_int63 = None; retro_float64 = None; retro_string = None;
      retro_array = None }
  ...
  let merge r1 r2 =
    { retro_int63 =
      ...
      (match r1.retro_float64 with
       | Some v -> Some v
       | None -> r2.retro_float64); retro_string =
      (match r1.retro_string with
       | Some v -> Some v
       | None -> r2.retro_string); retro_array =
...
module Environment =
 ...
 struct
  ...
  | Coq_primString -> _UU03a3_.retroknowledge.Retroknowledge.retro_string
